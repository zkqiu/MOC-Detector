...
PATH_TO_SAVE_MODEL=../experiment/result_model/K7_rgb_coco_dla_single

GPU=0,1,2,3
# CUDA_VISIBLE_DEVICES=$GPU python3 train.py --K 7 --exp_id Train_K7_rgb_coco_dla_single --rgb_model $PATH_TO_SAVE_MODEL --batch_size 32 --master_batch 8 --lr 5e-4 --gpus $GPU --num_workers 16 --num_epochs 12 --lr_step 6,9 --save_all


# -------------------- Evaluation --------------------
PATH_TO_RGB_MODEL='K7_rgb_coco_dla_single/model_[12]_2020-10-24-06-26.pth'
PATH_TO_FLOW_MODEL='K7_flow_coco_dla_single/model_[12]_2020-10-26-03-45.pth'
INFERENCE_DIR='../experiment/result_model/K7_rgb_coco_dla_single/rgb_flow_inference'

CUDA_VISIBLE_DEVICES=$GPU python3 det.py --task normal --K 7 --gpus $GPU --batch_size 16 --master_batch 4 --num_workers 16 --rgb_model ../experiment/result_model/$PATH_TO_RGB_MODEL --flow_model ../experiment/result_model/$PATH_TO_FLOW_MODEL --inference_dir $INFERENCE_DIR --flip_test --ninput 5
